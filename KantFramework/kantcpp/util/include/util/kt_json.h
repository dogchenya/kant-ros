...
*/
struct KT_Json_Exception : public KT_Exception {
  KT_Json_Exception(const string& buffer) : KT_Exception(buffer){};
  ~KT_Json_Exception() throw(){};
};
...
typedef std::shared_ptr<JsonValueNull> JsonValueNullPtr;
...
typedef std::shared_ptr<JsonValueString> JsonValueStringPtr;
...
typedef std::shared_ptr<JsonValueNum> JsonValueNumPtr;
...
typedef std::shared_ptr<JsonValueObj> JsonValueObjPtr;
...
typedef std::shared_ptr<JsonValueArray> JsonValueArrayPtr;
...
typedef std::shared_ptr<JsonValueBoolean> JsonValueBooleanPtr;
