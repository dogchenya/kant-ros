...
struct RequestPacket : public kant::KantStructBase {
 public:
  static string className() { return "kant.RequestPacket"; }
  static string MD5() { return "2a077f9b4ba3951ae36bed7ae78b580e"; }
  RequestPacket() { resetDefautlt(); }
  void resetDefautlt() {
    iVersion = 0;
    cPacketType = 0;
    iMessageType = 0;
  ...
  string writeToJsonString() const { return kant::KT_Json::writeValue(writeToJson()); }
  ...
  void readFromJsonString(const string& str) { readFromJson(kant::KT_Json::getValue(str)); }
...
inline bool operator==(const RequestPacket& l, const RequestPacket& r) {
  return l.iVersion == r.iVersion && l.cPacketType == r.cPacketType && l.iMessageType == r.iMessageType &&
         l.iRequestId == r.iRequestId && l.sServantName == r.sServantName && l.sFuncName == r.sFuncName &&
         l.sBuffer == r.sBuffer && l.iTimeout == r.iTimeout && l.context == r.context && l.status == r.status;
}
inline bool operator!=(const RequestPacket& l, const RequestPacket& r) { return !(l == r); }
...
struct ResponsePacket : public kant::KantStructBase {
 public:
  static string className() { return "kant.ResponsePacket"; }
  static string MD5() { return "d0337220d89fccd5aa21b25920dbcb2b"; }
  ResponsePacket() { resetDefautlt(); }
  void resetDefautlt() {
    iVersion = 0;
    cPacketType = 0;
    iRequestId = 0;
...
inline bool operator==(const ResponsePacket& l, const ResponsePacket& r) {
  return l.iVersion == r.iVersion && l.cPacketType == r.cPacketType && l.iRequestId == r.iRequestId &&
         l.iMessageType == r.iMessageType && l.iRet == r.iRet && l.sBuffer == r.sBuffer && l.status == r.status &&
         l.sResultDesc == r.sResultDesc && l.context == r.context;
}
inline bool operator!=(const ResponsePacket& l, const ResponsePacket& r) { return !(l == r); }
