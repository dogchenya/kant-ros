#ifndef _KT_CLIENTSOCKET_H_
#define _KT_CLIENTSOCKET_H_
...
*/
struct KT_EndpointParse_Exception : public KT_Exception {
  KT_EndpointParse_Exception(const string &buffer) : KT_Exception(buffer){};
  ~KT_EndpointParse_Exception() throw(){};
};
...
class KT_Endpoint {
 public:
  ...
  /**
     ...
     */
  KT_Endpoint(const string &host, int port, int timeout, EType type = TCP, int grid = 0, int qos = 0, int weight = -1,
              unsigned int weighttype = 0, AUTH_TYPE authType = AUTH_TYPENONE) {
  ...
  /**
     ...
     * @param desc
     */
  KT_Endpoint(const string &desc) { parse(desc); }
  ...
  /**
     ...
     * @param l
     */
  KT_Endpoint(const KT_Endpoint &l) {
    _host = l._host;
    _port = l._port;
    _timeout = l._timeout;
    _type = l._type;
  ...
  /**
     ...
     * @return KT_Endpoint&
     */
  KT_Endpoint &operator=(const KT_Endpoint &l) {
    if (this != &l) {
      _host = l._host;
      _port = l._port;
      _timeout = l._timeout;
  ...
  /**
     ...
     * @return bool
     */
  bool operator==(const KT_Endpoint &l) const {
    return (_host == l._host && _port == l._port && _timeout == l._timeout && _type == l._type && _grid == l._grid &&
            _qos == l._qos && _weight == l._weight && _weighttype == l._weighttype && _authType == l._authType &&
            _isIPv6 == l._isIPv6);
  }
 ...
 private:
  void init(const string &host, int port, int timeout, EType type, int grid, int qos, int weight,
...
class KT_ClientSocket {
 public:
  ...
  /**
    ...
    */
  KT_ClientSocket(const string &sIp, int iPort, int iTimeout) { init(sIp, iPort, iTimeout); }
  ...
  /**
     ...
     * @return
     */
  KT_Socket *getSocket() { return &_socket; }
 ...
 */
class KT_TCPClient : public KT_ClientSocket {
 public:
  /**
    * @brief  构造函数
    * @brief  Constructor
  ...
  /**
    ...
    * @param iTimeout  Timeout, unit: ms
    */
  KT_TCPClient(const string &sIp, int iPort, int iTimeout) : KT_ClientSocket(sIp, iPort, iTimeout) {}
...
/**
  ...
  */
class KT_UDPClient : public KT_ClientSocket {
 public:
  /**
    * @brief  构造函数
    * @brief  Constructor
  ...
  /**
    ...
    * @param iTimeout  Timeout, unit: ms
    */
  KT_UDPClient(const string &sIp, int iPort, int iTimeout) : KT_ClientSocket(sIp, iPort, iTimeout) {}
  ...
  /**
     ...
     * @return int: 0 success, <0 fail
     */
  int sendRecv(const char *sSendBuffer, size_t iSendLen, char *sRecvBuffer, size_t &iRecvLen, string &sRemoteIp,
