#ifndef __KT_DOCKER_H_
#define __KT_DOCKER_H_
...
/**
 * 操作docker, 提供几个关键的api, kantregistry/kantnode中会使用到
 * 注意:
 * - 同步等待操作docker, 会阻塞
 */
class KT_Docker {
 public:
  ...
  /**
	 ...
	 * @return
	 */
  bool create(const string &name, const string &image, const vector<string> &entrypoint, const vector<string> &commands,
              const vector<string> &envs, const map<string, string> &mounts,
 ...
 protected:
  /**
	 ...
	 * @return
	 */
  bool createHttpRequest(KT_HttpRequest &req);
