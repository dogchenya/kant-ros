...
TEST_F(UtilClientSocketTest, testSepEndpointOK) {
  vector<string> v = KT_Endpoint::sepEndpoint("tcp -h 127.0.0.1 -p 17890 -t 3000:tcp -h 127.0.0.1 -p 17890 -t 3001");

  LOG_CONSOLE_DEBUG << v.size() << ", " << KT_Common::tostr(v.begin(), v.end(), ", ") << endl;
...
TEST_F(UtilClientSocketTest, testSepEndpoint1) {
  vector<string> v = KT_Endpoint::sepEndpoint("tcp -h 127.0.0.1 -p 17890 -t 3000:");
