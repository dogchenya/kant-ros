#ifndef __KT_PARSEPARA_H
#define __KT_PARSEPARA_H
...
class KT_Parsepara {
 public:
  ...
  /**
    ...
    * @param : Types such as name=value&name=value string
    */
  KT_Parsepara(const string &sParam);
  ...
  /**
    ...
    * @param : Types such as name=value&name=value string
    */
  KT_Parsepara(const map<string, string> &mpParam);

  /**
    * @brief  copy contructor
    */
  KT_Parsepara(const KT_Parsepara &para);

  /**
    * =
    */
  KT_Parsepara &operator=(const KT_Parsepara &para);

  /**
    * ==
    */
  bool operator==(const KT_Parsepara &para);

  /**
    *+
    */
  const KT_Parsepara operator+(const KT_Parsepara &para);
  ...
  /**
    ...
    */
  typedef int (*KT_ParseparaTraverseFunc)(string, string, void *);
  ...
  /**
    ...
    * @return void
    */
  void traverse(KT_ParseparaTraverseFunc func, void *pParam);
