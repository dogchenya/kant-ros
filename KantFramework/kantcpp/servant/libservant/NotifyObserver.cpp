...
void NotifyObserver::registerNotify(const string& command, BaseNotify* obj) { registerObject(command, obj, _notifys); }

void NotifyObserver::unregisterNotify(const string& command, BaseNotify* obj) {
  unregisterObject(command, obj, _notifys);
}

void NotifyObserver::registerPrefix(const string& command, BaseNotify* obj) { registerObject(command, obj, _prefix); }
...
string NotifyObserver::notify(const string& command, CurrentPtr current) {
  ...
  string str = KT_Common::trim(command);
