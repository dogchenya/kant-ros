...
option(KANT_MYSQL "option for mysql" OFF)
option(KANT_SSL "option for ssl" OFF)
option(KANT_HTTP2 "option for http2" OFF)
option(KANT_PROTOBUF "option for protocol" OFF)
option(KANT_GPERF    "option for gperf" OFF)
...
if (KANT_MYSQL)
    add_definitions(-DKANT_MYSQL=1)
endif ()

if (KANT_GPERF)
    add_definitions(-DKANT_GPERF=1)
endif ()

if (KANT_SSL)
    add_definitions(-DKANT_SSL=1)
endif ()

if (KANT_HTTP2)
    add_definitions(-DKANT_HTTP2=1)
endif ()

if (KANT_PROTOBUF)
    add_definitions(-DKANT_PROTOBUF=1)
endif ()
...
if (WIN32)
    ...
    set(LIB_GTEST "gtest")
    #vscode 打开是会锁定文件 导致解压的文件被锁定 无法重命名
    ExternalProject_Add(ADD_${LIB_GTEST}
...
message("----------------------------------------------------")
message("KANT_MYSQL:                ${KANT_MYSQL}")
message("KANT_HTTP2:                ${KANT_HTTP2}")
message("KANT_SSL:                  ${KANT_SSL}")
message("KANT_PROTOBUF:             ${KANT_PROTOBUF}")
message("KANT_GPERF:                ${KANT_GPERF}")
