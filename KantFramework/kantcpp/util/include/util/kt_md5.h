 ...
 * @brief MD5 exception
 */
struct KT_MD5_Exception : public KT_Exception {
  KT_MD5_Exception(const string &buffer, int err) : KT_Exception(buffer, err){};
  ~KT_MD5_Exception() throw(){};
};
...
class KT_MD5 {
 ...
 public:
  ...
  /**
     ...
     * @throw KT_MD5_Exception, 文件读取错误会抛出异常 
     * @throw KT_MD5_Exception, File read error throws an exception
