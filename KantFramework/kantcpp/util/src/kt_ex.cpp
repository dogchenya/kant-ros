...
KT_Exception::KT_Exception(const string& buffer) : _code(0), _buffer(buffer) {}
...
const char* KT_Exception::what() const throw() { return _buffer.c_str(); }
...
string KT_Exception::getSystemError() { return parseError(getSystemCode()); }
}  // namespace kant
