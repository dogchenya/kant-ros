...
IF (UNIX)
    set(CMAKE_INSTALL_PREFIX "/usr/local/kant/cpp" CACHE STRING "set install path" FORCE)
ELSE()
    set(CMAKE_INSTALL_PREFIX "c:\\kant\\cpp" CACHE STRING "set install path" FORCE)
ENDIF()
...
#-------------------------------------------------------------
set(KANT2CPP "${CMAKE_BINARY_DIR}/bin/kant2cpp")
